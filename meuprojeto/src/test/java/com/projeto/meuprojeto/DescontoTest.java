...
public class DescontoTest {
    ...
    void bdd1_AlunoCom3CursosEMediaMaiorOuIgual8_DeveConceder40PorCento() {
        ...
        double desconto = SolicitarDescontoUseCase.solicitarDesconto(aluno);
    ...
    void bdd4_AlunoComMenosDe3Cursos_DeveExibirMensagem() {
        ...
        String mensagem = SolicitarDescontoUseCase.solicitarDescontoComMensagem(aluno);
        assertEquals(
    ...
    void media80_da40() {
        ...
        assertEquals(0.40, SolicitarDescontoUseCase.solicitarDesconto(a), 1e-6);
    }

    @Test
    void media79_da20() {
        Aluno a = new Aluno("B", 3, 7.9);
        assertEquals(0.20, SolicitarDescontoUseCase.solicitarDesconto(a), 1e-6);
    }
    ...
    void cursosSuficientes_mediaBaixa_daZero() {
        ...
        assertEquals(0.0, SolicitarDescontoUseCase.solicitarDesconto(a), 1e-6);
    }

    @Test
    void mensagem_quandoCursosSuficientes_mediaAlta_40() {
        Aluno a = new Aluno("E", 3, 8.1);
        assertEquals("Desconto aplicado: 40%", SolicitarDescontoUseCase.solicitarDescontoComMensagem(a));
    }

    @Test
    void mensagem_quandoCursosSuficientes_mediaMedia_20() {
        Aluno a = new Aluno("F", 3, 7.5);
        assertEquals("Desconto aplicado: 20%", SolicitarDescontoUseCase.solicitarDescontoComMensagem(a));
    }
